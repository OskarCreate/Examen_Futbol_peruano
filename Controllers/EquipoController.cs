...
namespace Examen_Futbol_peruano.Controllers
{
    ...
    public class EquipoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Ciudad")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Ciudad")] Equipo equipo)
        {
            if (id != equipo.Id)
            {
                return NotFound();
